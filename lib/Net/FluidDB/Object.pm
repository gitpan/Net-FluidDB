...
sub has_tag {
    my ($class, $fdb, $object_id, $tag_or_tag_path) = @_;
...
=item Net::FluidDB::Object->get_by_id($fdb, $id, %opts)
...
=item Net::FluidDB::Object->get_by_about($fdb, $about)

Retrieves the object with about C<$about> from FluidDB.
...
=item Net::FluidDB::Object->has_tag($fdb, $object_id, $tag_or_tag_path)

When you retrieve an object from FluidDB the instance has the paths
